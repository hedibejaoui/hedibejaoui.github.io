$("#status").fadeOut(),
    ...
    $(".navbar-nav a, .scroll_down a").on("click", function (e) {
        ...
        $("html, body")
            .stop()
            .animate({ scrollTop: $(t.attr("href")).offset().top - 0 }, 1500, "easeInOutExpo"),
            e.preventDefault();
    }),
...
$(window).on("scroll", function () {
    var e = $("#counter")
    if (e.length) {
        e.offset().top - window.innerHeight;
        0 == a &&
            $(window).scrollTop() > e &&
    ...
    $(window).on("load", function () {
        ...
        e.isotope({ filter: "*", layoutMode: "masonry", animationOptions: { duration: 750, easing: "linear" } }),
            t.find("a").on("click", function () {
                ...
                return t.find("a").removeClass("active"), $(this).addClass("active"), e.isotope({ filter: o, animationOptions: { animationDuration: 750, easing: "linear", queue: !1 } }), !1;
            });
    }),
    ...
    $(".blog_play").magnificPopup({ disableOn: 700, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !1 }),
    $(window).on("scroll", function () {
...
// This block is responsible for randomizing the owl-caroussel containing the testimonials
...
$(function () {
    $(".owl-carousel .people_says").shuffle();
owl.owlCarousel();
    });